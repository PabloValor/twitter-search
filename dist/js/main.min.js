...
!function(){"use strict";angular.module("twitterSearch.controllers",[]).controller("twitterSearchController",["$scope","twitterSearchService",function(t,e){t.submit=function(r){t.tweets=[],t.progressBarFlag=!0,e.getTweets(r).then(function(e){t.tweets=e.statuses,t.progressBarFlag=!1})}}])}();
!function(){"use strict";angular.module("twitterSearch.services",[]).factory("twitterSearchService",["$http","$q",function(e,t){function r(r){var c=t.defer();return e.post("/",{userSearch:r}).success(function(e){c.resolve(e)}),c.promise}return{getTweets:r}}])}();
