...
!function(){"use strict";angular.module("twitterSearch.controllers",[]).controller("twitterSearchController",["$scope","twitterSearchService",function(t,e){t.submit=function(r){t.tweets=[],t.progressBarFlag=!0,e.getTweets(r).then(function(e){t.tweets=e.statuses,t.progressBarFlag=!1,console.log(t.tweets)})}}])}();
...
$(document).on("ready",function(){"use strict";$("#search");$("#btnSearch").on("click",function(){setTimeout(function(){$(".tooltipped").tooltip({delay:50})},2500)}),console.log("dom ready...")});