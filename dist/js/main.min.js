...
!function(){"use strict";var t=angular.module("TwitterSearch",["twitterSearch.controllers","twitterSearch.services"]);t.config(["$interpolateProvider",function(t){t.startSymbol("[["),t.endSymbol("]]")}])}();
!function(){"use strict";angular.module("twitterSearch.controllers",[]).controller("twitterSearchController",["$scope","twitterSearchService",function(t,e){t.submit=function(){t.tweets=[],t.tweetsCounter=5,t.progressBarFlag=!0,e.getTweets(t.search,t.tweetsCounter).then(function(e){t.tweets=e.statuses}),t.progressBarFlag=!1},t.loadMore=function(){t.tweetsCounter+=5,t.progressBarFlag=!0,e.getTweets(t.search,t.tweetsCounter).then(function(e){t.tweets=[],e.statuses.forEach(function(e){t.tweets.push(e)})}),t.progressBarFlag=!1}}])}();
!function(){"use strict";angular.module("twitterSearch.services",[]).factory("twitterSearchService",["$http","$q",function(e,t){function r(r,c){var n=t.defer();return e.post("/",{userSearch:r,count:c}).success(function(e){n.resolve(e)}),n.promise}return{getTweets:r}}])}();
$(document).on("ready",function(){"use strict";var o=($("#search"),$("#up"));o.hide(),$(window).on("scroll",function(){$(this).scrollTop()?o.fadeIn():o.fadeOut()}),$("#btnSearch").on("click",function(){setTimeout(function(){$(".tooltipped").tooltip({delay:50})},2500)}),console.log("dom ready...")});