...
$(document).on("ready",function(){"use strict";function o(){setTimeout(function(){$(".tooltipped").tooltip({delay:50})},2500)}$("#btnSearch"),$("#btnLoadMore");$("#btnSearch").on("click",o),$("#btnLoadMore").on("click",o),console.log("dom ready...")});